...
const estimatedStatusBarHeight = ((_NativeModules$Native = _reactNative.NativeModules.NativeUnimoduleProxy) === null || _NativeModules$Native === void 0 || (_NativeModules$Native = _NativeModules$Native.modulesConstants) === null || _NativeModules$Native === void 0 || (_NativeModules$Native = _NativeModules$Native.ExponentConstants) === null || _NativeModules$Native === void 0 ? void 0 : _NativeModules$Native.statusBarHeight) ?? 0;
const APPROX_STATUSBAR_HEIGHT = exports.APPROX_STATUSBAR_HEIGHT = _reactNative.Platform.select({
  ...
  ios: typeof _reactNative.Platform.Version === 'number' && _reactNative.Platform.Version < 11 ? estimatedStatusBarHeight : 0
});
