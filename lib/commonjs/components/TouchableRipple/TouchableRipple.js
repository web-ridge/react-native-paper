...
function TouchableRipple(_ref) {
  ...
  const calculatedRippleColor = React.useMemo(() => rippleColor || (0, _color.default)(theme.colors.text).alpha(theme.dark ? 0.32 : 0.2).rgb().string(), [rippleColor, theme.colors.text, theme.dark]);
  ...
  const onRemove = React.useCallback(ripple => {
  ...
  }), interactionState => /*#__PURE__*/React.createElement(React.Fragment, null, React.Children.only((0, _utils.getInteractionChildren)(interactionState, children)), /*#__PURE__*/React.createElement(_reactNative.View, {
...
const TouchableRippleWithTheme = (0, _theming.withTheme)(TouchableRipple);
const TouchableRippleMemo = /*#__PURE__*/React.memo(TouchableRippleWithTheme);
TouchableRippleMemo.supported = true;
var _default = TouchableRippleMemo;
