...
const TouchableRipple = ({
  ...
  return /*#__PURE__*/React.createElement(_Pressable.Pressable, _extends({}, rest, {
    ...
    disabled: disabled,
    style: [borderless && styles.overflowHidden, style]
  }), state => /*#__PURE__*/React.createElement(React.Fragment, null, state.pressed && rippleEffectEnabled && /*#__PURE__*/React.createElement(_reactNative.View, {
    testID: "touchable-ripple-underlay",
    style: [styles.underlay, {
      backgroundColor: calculatedUnderlayColor
    }]
  }), React.Children.only(typeof children === 'function' ? children(state) : children)));
};
