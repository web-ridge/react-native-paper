...
const RadioButtonAndroid = (_ref) => {
  ...
  const uncheckedColor = React.useMemo(() => rest.uncheckedColor || (0, _color.default)(theme.colors.text).alpha(theme.dark ? 0.7 : 0.54).rgb().string(), [rest.uncheckedColor, theme.colors.text, theme.dark]);
...
var _default = /*#__PURE__*/React.memo((0, _theming.withTheme)(RadioButtonAndroid)); // @component-docs ignore-next-line


exports.default = _default;
const RadioButtonAndroidWithTheme = /*#__PURE__*/React.memo((0, _theming.withTheme)(RadioButtonAndroid)); // @component-docs ignore-next-line
