...
const RadioButtonItem = ({
  ...
  if (mode === 'android') {
    ...
    //@ts-ignore
    radioButton = /*#__PURE__*/React.createElement(_RadioButtonElements.RadioButton, radioButtonProps);
  }
  ...
  return /*#__PURE__*/React.createElement(_RadioButtonGroup.RadioButtonContext.Consumer, null, context => {
    return /*#__PURE__*/React.createElement(_TouchableRipple.default, {
      onPress: disabled ? undefined : event => (0, _utils.handlePress)({
        onPress,
...
var _default = /*#__PURE__*/React.memo((0, _theming.withTheme)(RadioButtonItem)); // @component-docs ignore-next-line


exports.default = _default;
const RadioButtonItemWithTheme = /*#__PURE__*/React.memo((0, _theming.withTheme)(RadioButtonItem)); // @component-docs ignore-next-line
