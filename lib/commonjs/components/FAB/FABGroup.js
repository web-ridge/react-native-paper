...
const FABGroup = ({
  ...
  return /*#__PURE__*/React.createElement(_reactNative.View, {
  ...
  }, it.label)), /*#__PURE__*/React.createElement(_FABElements.FAB, {
    small: true,
    icon: it.icon,
    color: it.color,
    style: [{
    ...
    testID: it.testID,
    visible: open
  })))), /*#__PURE__*/React.createElement(_FABElements.FAB, {
    onPress: e => {
...
var _default = /*#__PURE__*/React.memo((0, _theming.withTheme)(FABGroup)); // @component-docs ignore-next-line


exports.default = _default;
const FABGroupWithTheme = /*#__PURE__*/React.memo((0, _theming.withTheme)(FABGroup)); // @component-docs ignore-next-line
