...
const Button = (_ref) => {
  ...
  let {
    ...
    accessible
      ...
      rest = _objectWithoutProperties(_ref, ["disabled", "compact", "mode", "dark", "loading", "icon", "color", "children", "uppercase", "accessibilityLabel", "onPress", "onLongPress", "onPressIn", "onPressOut", "style", "theme", "contentStyle", "labelStyle", "testID", "accessible"]);
...
var _default = /*#__PURE__*/React.memo((0, _theming.withTheme)(Button));
