...
const Tooltip = ({
  ...
  const mobilePressProps = {
    onPress: React.useCallback(() => {
      if (touched.current) {
        ...
        return (_onPress = (_ref = children.props).onPress) === null || _onPress === void 0 ? void 0 : _onPress.call(_ref);
      }
    }, [children.props]),
  ...
  const webPressProps = {
    onHoverIn: () => {
      var _onHoverIn, _ref2;
      handleTouchStart();
      (_onHoverIn = (_ref2 = children.props).onHoverIn) === null || _onHoverIn === void 0 || _onHoverIn.call(_ref2);
    },
    onHoverOut: () => {
      var _onHoverOut, _ref3;
      handleTouchEnd();
      (_onHoverOut = (_ref3 = children.props).onHoverOut) === null || _onHoverOut === void 0 || _onHoverOut.call(_ref3);
    }
  };
