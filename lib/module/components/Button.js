...
const Button = (_ref) => {
  ...
  let {
    ...
    testID
      ...
      rest = _objectWithoutProperties(_ref, ["disabled", "compact", "mode", "dark", "loading", "icon", "color", "children", "uppercase", "accessibilityLabel", "onPress", "onLongPress", "onPressIn", "onPressOut", "style", "theme", "contentStyle", "labelStyle", "testID"]);
