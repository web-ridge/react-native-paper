...
export default /*#__PURE__*/React.memo(withTheme(AppbarHeader)); // @component-docs ignore-next-line

const AppbarHeaderWithTheme = /*#__PURE__*/React.memo(withTheme(AppbarHeader)); // @component-docs ignore-next-line
