...
const AppbarAction = (_ref) => {
  let {
    ...
    accessibilityLabel
      ...
      rest = _objectWithoutProperties(_ref, ["size", "color", "icon", "disabled", "onPress", "accessibilityLabel"]);
...
export default /*#__PURE__*/React.memo(AppbarAction); // @component-docs ignore-next-line
