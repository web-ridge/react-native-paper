...
const RadioButtonAndroid = (_ref) => {
  ...
  const uncheckedColor = React.useMemo(() => rest.uncheckedColor || color(theme.colors.text).alpha(theme.dark ? 0.7 : 0.54).rgb().string(), [rest.uncheckedColor, theme.colors.text, theme.dark]);
...
export default /*#__PURE__*/React.memo(withTheme(RadioButtonAndroid)); // @component-docs ignore-next-line

const RadioButtonAndroidWithTheme = /*#__PURE__*/React.memo(withTheme(RadioButtonAndroid)); // @component-docs ignore-next-line
