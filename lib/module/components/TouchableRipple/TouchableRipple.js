...
function TouchableRipple(_ref) {
  ...
  const calculatedRippleColor = React.useMemo(() => rippleColor || color(theme.colors.text).alpha(theme.dark ? 0.32 : 0.2).rgb().string(), [rippleColor, theme.colors.text, theme.dark]);
