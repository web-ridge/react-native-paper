...
declare const _default: (React.ComponentClass<Pick<import("react-native").TextProps & {
     ...
     */
    theme: ReactNativePaper.Theme;
} & React.RefAttributes<{}>, any> & React.ForwardRefExoticComponent<import("react-native").TextProps & {
    style?: StyleProp<TextStyle>;
    /**
     * @optional
     */
    theme: ReactNativePaper.Theme;
} & React.RefAttributes<{}>>) | (React.FunctionComponent<import("react-native").TextProps & {
    style?: StyleProp<TextStyle>;
    /**
     * @optional
     */
     ...
     */
    theme: ReactNativePaper.Theme;
} & React.RefAttributes<{}>>), {}>) | (React.FunctionComponent<Pick<import("react-native").TextProps & {
    style?: StyleProp<TextStyle>;
    /**
     * @optional
     */
