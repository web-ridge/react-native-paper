...
declare const AffixAdornment: React.NamedExoticComponent<{
...
declare const _default: React.MemoExoticComponent<(React.ComponentClass<Pick<Props, "text" | "onLayout" | "textStyle"> & {
